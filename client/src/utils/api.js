...
export default { 
    apiArticles: function(topic, startYear, endYear) {
      ...
      let url = `https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=1192f3759b9447058954d162bd070ffe&q=${topic}&begin_date=${startYear}0101&end_date=${endYear}1231&fl=web_url,headline,pub_date`;
